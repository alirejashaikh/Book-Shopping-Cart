...
function AdminLogin() {
    ...
    const apiUrl = "http://localhost:62018/api/Admin/LoginPost";  
                    ...
                    <div className="row g-0">
                        ...
                        <div className="card-body p-md-5 mx-md-4">
                            ...
                            <div className="form-outline mb-4">
                                <input type="text" id="form2Example11" className="form-control" onChange={onChange} name='UserName' value={data.UserName} placeholder="Enter username"/>
                        ...
                        <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                            <h4 className="mb-4">We supply water billing service</h4>
                            <p className="small mb-0">Fill your details to Register or Login into the Admin Page</p>
                        </div>
                        </div>
                    </div>
                    </div>
